/*
 * BstPrintKeyRange.cpp
 * run command
 * g++ /media/program/cprogram/git_repo/Algorithm/src/InterviewPreparation/binary_tree/BstPrintKeyRange.cpp -o /usr/build/Main.o
 *
...
class Solution
{
	...
	void Print(TreeNode *root ,const KeyType &min , const KeyType &max)
	{
		if(root)
		{
			if(root->key < min)
