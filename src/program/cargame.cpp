/* Language: C\C++ (To convert to C, just change cout to printf and cin to scanf and change the library files)
 Category: Games\Graphics Description:
 RACE CRAZE::A car racing game.
 You have to reach the finish line before the time goes out.
 There are many hurdles in your way. So be careful. */
 #include <iostream.h>
 #include <dos.h>
 #include <graphics.h>
 #include <conio.h>
...
// sound(1000);
 ...
 //car body floodfill(x1+10,y2+10,col);

 setcolor(col2);

 //windows setfillstyle(2,col2);
 ...
 } void get() { settextstyle(1,0,1);

 char* minn;

 if (min>9) { int minnn=min/10;
 ...
 } void track(int n,int coll) { setcolor(coll);
 ...
 if (miles>99) { int minnn=miles/100;
 ...
 if (i==75) { c.get(k,j+100,k+70,j,0,0,0);
 ...
 } if (i==155) { c.get(k,j+100,k+70,j,0,0,0);
 ...
 } if (i==77) { c.get(k,j+100,k+70,j,0,0,0);
 ...
 } if (i==157) { c.get(k,j+100,k+70,j,0,0,0);
 ...
 } if (flg==2) { (r1==0)?c1.get(200,l+stage,270,l+stage-100,0,0,0): c1.get(335,l+stage,405,l+stage-100,0,0,0);
 ...
 } } if (flg==3) { (r1==0)?c1.get(200,l+stage,270,l+stage-100,0,0,0) :c1.get(335,l+stage,405,l+stage-100,0,0,0);
 ...
 if (i<8) outtextxy(50,100,"CONGRATULATIONS! \ You have won the competetion");

 else outtextxy(50,100,"SORRY! You fell \ out of time");
