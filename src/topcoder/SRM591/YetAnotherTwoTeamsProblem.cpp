...
double test0() {
	...
	YetAnotherTwoTeamsProblem * obj = new YetAnotherTwoTeamsProblem();
	clock_t start = clock();
...
double test4() {
	int t0[] = {999, 999, 999, 1000, 1000, 1001, 999, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000,
